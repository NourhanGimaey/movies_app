...
import '../../features/auth/data/repositories/auth_repository_impl.dart'
    as _i662;
import '../../features/auth/domain/repositories/auth_repository.dart' as _i723;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i862.AuthRemoteDataSource>(
      () => _i193.RemoteDataSourceImpl(gh<_i170.AuthRetrofitApiClient>()),
    );
    gh.lazySingleton<_i723.AuthRepository>(
      () => _i662.AuthRepositoryImpl(gh<_i862.AuthRemoteDataSource>()),
    );
    gh.factory<_i1010.RegisterUseCase>(
      () => _i1010.RegisterUseCase(gh<_i723.AuthRepository>()),
    );
