...
class RemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  const RemoteDataSourceImpl(this._authRetrofitApiClient);
  ...
  Future<Either<Failure, RegisterResponseModel>> register(
    ...
    try {
      final response = await _authRetrofitApiClient.register(registerRequest);
  ...
  Future<Either<Failure, LoginResponseModel>> login(
    ...
    try {
      final response = await _authRetrofitApiClient.login(loginRequest);
      return Right(response);
    } catch (e) {
      final errorHandler = ErrorHandler.handle(e);
      return Left(errorHandler.failure);
